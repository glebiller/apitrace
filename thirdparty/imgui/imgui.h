...
namespace ImGui
{
    ...
    //  - Helpers to do OpenPopup+BeginPopup where the Select action is triggered by e.g. hovering an item and right-clicking.
    ...
    // Background/Foreground UpdateFromDraw Lists
...
enum ImGuiTreeNodeFlags_
{
    ...
    ImGuiTreeNodeFlags_Selected             = 1 << 0,   // UpdateFromDraw as selected
    ImGuiTreeNodeFlags_Framed               = 1 << 1,   // UpdateFromDraw frame with background (e.g. for CollapsingHeader)
...
enum ImGuiTableFlags_
{
    ...
    ImGuiTableFlags_BordersInnerH              = 1 << 7,   // UpdateFromDraw horizontal borders between rows.
    ImGuiTableFlags_BordersOuterH              = 1 << 8,   // UpdateFromDraw horizontal borders at the top and bottom.
    ImGuiTableFlags_BordersInnerV              = 1 << 9,   // UpdateFromDraw vertical borders between columns.
    ImGuiTableFlags_BordersOuterV              = 1 << 10,  // UpdateFromDraw vertical borders on the left and right sides.
    ImGuiTableFlags_BordersH                   = ImGuiTableFlags_BordersInnerH | ImGuiTableFlags_BordersOuterH, // UpdateFromDraw horizontal borders.
    ImGuiTableFlags_BordersV                   = ImGuiTableFlags_BordersInnerV | ImGuiTableFlags_BordersOuterV, // UpdateFromDraw vertical borders.
    ImGuiTableFlags_BordersInner               = ImGuiTableFlags_BordersInnerV | ImGuiTableFlags_BordersInnerH, // UpdateFromDraw inner borders.
    ImGuiTableFlags_BordersOuter               = ImGuiTableFlags_BordersOuterV | ImGuiTableFlags_BordersOuterH, // UpdateFromDraw outer borders.
    ImGuiTableFlags_Borders                    = ImGuiTableFlags_BordersInner | ImGuiTableFlags_BordersOuter,   // UpdateFromDraw all borders.
...
enum ImGuiKey : int
{
    ...
    ImGuiKey_GamepadFaceDown,       // A (Xbox)         B (Switch)   Cross (PS)         // Activate / Select / Toggle / Tweak
...
// ImDrawCallback: UpdateFromDraw callbacks for advanced uses [configurable type: override in imconfig.h]
// NB: You most likely do NOT need to use draw callbacks just to create your own widget or customized UI rendering,
// you can poke into the draw list for that! UpdateFromDraw callback may be useful for example to:
...
// Special UpdateFromDraw callback value to request renderer backend to reset the graphics/render state.
...
struct ImDrawListSplitter
{
    ...
    ImVector<ImDrawChannel>     _Channels;   // UpdateFromDraw channels (not resized down so _Count might be < Channels.Size)
...
struct ImDrawList
{
    ...
    ImVector<ImDrawCmd>     CmdBuffer;          // UpdateFromDraw commands. Typically 1 command = 1 GPU draw call, unless the command is a callback.
